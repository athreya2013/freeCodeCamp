...
You will do an insertion similar to a normal Binary Search Tree insertion. After inserting, you fix the AVL property using left or right rotations.
  ...
  - If there is an imbalance in left child of right subtree, then you perform a right-left rotation.  
  ...
  - If there is an imbalance in right child of left subtree, then you perform a left-right rotation.  
